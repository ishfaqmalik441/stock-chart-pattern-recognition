...
results_df['ihs_early_avg'].plot.bar(ax=ax[0,1], color='red')
results_df['ihs_early_total'].plot.bar(ax=ax[1,0], color='blue')
results_df['ihs_early_wr'].plot.bar(ax=ax[1,1], color='yellow')
ax[0,1].hlines(0.0, xmin=-1, xmax=len(orders), color='white')
ax[1,0].hlines(0.0, xmin=-1, xmax=len(orders), color='white')
ax[1,1].hlines(0.5, xmin=-1, xmax=len(orders), color='white')
ax[0,0].set_title('Number of Patterns Found', pad=5)
...
fig, ax = plt.subplots(2, 2, figsize=(15, 10))
fig.suptitle("HS Early Performance Hold Period", fontsize=16)
results_df['hs_early_count'].plot.bar(ax=ax[0,0], color='green')
results_df['hs_early_avg'].plot.bar(ax=ax[0,1], color='red')
results_df['hs_early_total'].plot.bar(ax=ax[1,0], color='blue')
results_df['hs_early_wr'].plot.bar(ax=ax[1,1], color='yellow')
ax[0,1].hlines(0.0, xmin=-1, xmax=len(orders), color='white')
ax[1,0].hlines(0.0, xmin=-1, xmax=len(orders), color='white')
ax[1,1].hlines(0.5, xmin=-1, xmax=len(orders), color='white')
ax[0,0].set_title('Number of Patterns Found', pad=5)
